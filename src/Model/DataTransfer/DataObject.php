...
class DataObject implements \ArrayAccess
{
     ...
     * @return $this
     */
    public function addData(array $arr): DataObject
    {
        if ($this->_data === []) {
            $this->setData($arr);
            return $this;
     ...
     * @return $this
     */
    public function setData($key, $value = null): DataObject
    {
        if ($key === (array)$key) {
            $this->_data = $key;
        } else {
     ...
     * @return $this
     */
    public function setDataUsingMethod($key, $args = []): DataObject
    {
     ...
     * @return mixed
     */
    public function getDataUsingMethod(string $key, $args = null)
    {
     ...
     * @param  string  $method
     * @param  array  $args
     * @return $this|array|bool|mixed|DataObject|null
     * @throws \Exception
     */
     ...
     * @return array|string
     */
    public function debug($data = null, array &$objects = [])
    {
        if ($data === null) {
